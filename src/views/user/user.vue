<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="昵称" prop="nickname" style="width: 20px;"></el-table-column>
      <el-table-column align="center" label="用户名" prop="username" style="width: 20px;"></el-table-column>
      <el-table-column align="center" label="手机号" prop="phone" style="width: 20px;"></el-table-column>
      <el-table-column align="center" label="邮箱" prop="email" style="width: 20px;"></el-table-column>
      <el-table-column align="center" label="角色" width="100">
        <template slot-scope="scope">
          <el-tag type="success" v-text="scope.row.roleInfo.roleName" v-if="scope.row.roleInfo.id===1"></el-tag>
          <el-tag type="primary" v-text="scope.row.roleInfo.roleName" v-else></el-tag>
        </template>
      </el-table-column>
      <el-table-column align="center" label="创建时间" prop="createTime" width="170"></el-table-column>
      <el-table-column align="center" label="最近修改时间" prop="updateTime" width="170"></el-table-column>
      <el-table-column align="center" label="上次登录时间" prop="lastLoginTime" width="170"></el-table-column>

      <el-table-column align="center" label="启用" prop="isLock" width="170">
        <template slot-scope="scope">
            <toggleswitch
              v-model="scope.row.isLock"
              :value.sync="scope.row.isLock"
    ...
    methods: {
      ...
      getList() {
        ...
        this.api({
          ...
          this.totalCount = data.data.pages;
        })
      },
